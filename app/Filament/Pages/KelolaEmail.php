...
use App\Settings\PengaturanEmail;
...
class KelolaEmail extends SettingsPage
{
    use HasPageShield;

    protected static string $settings = PengaturanEmail::class;
    ...
    public function save(PengaturanEmail $settings = null): void
    {
        try {
            ...
            $this->sendSuccessNotification('Pengaturan mail diperbarui.');

            $this->redirect(static::getUrl(), navigate: FilamentView::hasSpaMode() && is_app_url(static::getUrl()));
        } catch (\Throwable $th) {
            $this->sendErrorNotification('Gagal memperbarui pengaturan mail. '.$th->getMessage());
            throw $th;
        }
    }

    public function sendTestMail(PengaturanEmail $settings = null)
    {
        $data = $this->form->getState();
